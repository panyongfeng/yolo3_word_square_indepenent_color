...
class Dataset:
    ...
    def parse_text(self, line):
        ...
        labels_idx = tf.math.mod(labels, 26)
        labels_color = tf.div(labels, 26) # 0:red, 1:blue
        ...
        y3.set_shape([None, None, len(self.anchors) // 1, self.num_classes + 6])
